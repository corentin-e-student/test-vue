<template>
    <div id="app-1">
        ...
        <b-list-group class="w-25 mt-5">
            <b-list-group-item class="d-flex justify-content-between align-items-center" v-for="({id, name}, index) in tools" :key="id" v-model="tool">
                {{ name }} <b-button variant="outline-danger" @click="removeTool2(index)">Suprimer</b-button>
            </b-list-group-item>
        </b-list-group>
