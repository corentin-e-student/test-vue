<template>
    <div id="app-1">
        ...
        <b-list-group class="w-25 mt-5">
            <b-list-group-item class="d-flex justify-content-between align-items-center" v-for="(tool, id) in todoList" :key="tool.id">
                {{ tool.name }} <b-button variant="outline-danger" @click="removeTool(id)">Suprimer</b-button>
            </b-list-group-item>
        </b-list-group>
